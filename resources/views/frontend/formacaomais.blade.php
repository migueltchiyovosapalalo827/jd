    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="container py-4 text-center">
                    <h2 style="font-weight: bold;">INSCREVA-SE NA FORMAÇÃO </h2>
                </div>
        ...
        <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="d-grid gap-2 col-3 mx-auto" style="padding-top: 20px;">
                <button class="btn botao" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                    data-bs-whatever="@mdo">Inscrever-se</button>
            </div>
                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <p class="mb-1">
                                ...
                                @endif
                                <br>
                                <a href="{{ route('candidatura', ['formacao' => $formacao->id]) }}" class="">Quero me
                                    cadastrar</a>
                            </p>
