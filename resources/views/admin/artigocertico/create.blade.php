        ...
        <div class="card card-outline card-info">
            <div class="card-header">
                <div class="float-left">
                    <div class="btn-group">
                        <a href="{{ route('artigoscienticos.index') }}" class="btn btn-sm btn-block btn-secondary"><i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
            </div>
            <div class="card-body">
            <form action="<?= route('artigoscienticos.store') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                           {{ csrf_field()}}
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text"  class="form-control @error('editora') is-invalid @enderror"  placeholder="descrição" name="editora" value="{{ old('editora') }}" >
                                @error('editora')
                                <div class="invalid-feedback">
                                    <h6>{{$message}}</h6>
                                </div>
