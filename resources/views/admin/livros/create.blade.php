...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
            <form action="<?= route('livros.store') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                           {{ csrf_field()}}
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input type="text" name="Autores" class="form-control @error('Autores') is-invalid @enderror" value="<?= old('Autores') ?>" placeholder="Autores" autocomplete="off">
                                @error('Autores')
                                <div class="invalid-feedback">
                                    <h6>{{$message}}</h6>
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text"  class="form-control @error('editora') is-invalid @enderror"  placeholder="editora" name="editora" value="{{ old('editora') }}" >
                                @error('editora')
                                <div class="invalid-feedback">
                                    <h6>{{$message}}</h6>
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text"  class="form-control @error('volume') is-invalid @enderror"  placeholder="volume" name="volume" value="{{ old('volume') }}" >
                                @error('volume')
                                <div class="invalid-feedback">
                                    <h6>{{$message}}</h6>
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <textarea class="form-control @error('resumo') is-invalid @enderror"  placeholder="resumo" name="resumo">{{ ltrim(old('resumo')) }}
