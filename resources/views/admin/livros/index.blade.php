...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lista de Livros Publicado </h1>
          </div>
          <div class="col-sm-6">
...
<div class="card card-default">
    <div class="card-header">
        <div class="card-tools">
            <div class="btn-group">
                <a href="{{route('livros.create')}}" class="btn btn-sm btn-block btn-primary"><i class="fa fa-plus"></i>
                cadastrar Livros
                </a>
            </div>
        </div>
            ...
            },
            {
                "data": function(data) {
                    return `<td class="text-right py-0 align-middle">
                            ...
                            <a href="{{url('livros/${data.id}/edit')}}" class="btn btn-primary btn-edit"><i class="fas fa-user-edit"></i></a>
    ...
    $(document).on('click', '.btn-delete', function(e) {
        Swal.fire({
            ...
            .then((result) => {
                if (result.value) {
                    $.ajax({
                        url: `{{url('livros')}}/${$(this).attr('data-id')}`,
                        method: 'DELETE',
