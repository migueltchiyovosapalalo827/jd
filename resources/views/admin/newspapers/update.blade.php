...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form action="{{ route('newspapers.update', $newspaper->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @method('PUT')
               @csrf
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" name="titulo" class="form-control @error('titulo') is-invalid @enderror" value="{{ $newspaper->titulo }}" placeholder="titulo" autocomplete="off">
                        @error('titulo')
            ...
            <div class="form-group row">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" name="pdf" class="custom-file-input  @error('pdf') is-invalid @enderror" id="exampleInputFile" >
                    <label class="custom-file-label" for="exampleInputFile">seleciona uma pdf para o newspaper</label>
                    @if ($errors->has('pdf'))
