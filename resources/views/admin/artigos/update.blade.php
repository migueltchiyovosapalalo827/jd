...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form action="{{ route('artigos.update', $artigo->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @method('PUT')
               @csrf
                ...
                <label for="mostrarpreco" class="col-sm-2 col-form-label">Categoria </label>
                  <div class="col-sm-8">
                   <select class="form-control  select2bs4 @error('tipo') is-invalid @enderror" data-placeholder="seleciona  uma opção" style="width: 100%;" name="categoria" id="categoria">
                             ...
                             <option value="{{$categoria->id}}"    {{ $artigo->categoria->id == $categoria->id ? "selected": "" }}  >{{ $categoria->nome }}</option>
                             @endforeach
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" name="titulo" class="form-control @error('titulo') is-invalid @enderror" value="{{ $artigo->titulo }}" placeholder="titulo" autocomplete="off">
                        @error('titulo')
                        <div class="invalid-feedback">
                            <h6>{{$message}}</h6>
                        </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" name="autor" class="form-control @error('autor') is-invalid @enderror" value="{{ $artigo->autor }}" placeholder="autor" autocomplete="off">
                        @error('autor')
                        <div class="invalid-feedback">
                            <h6>{{$message}}</h6>
                        </div>
            ...
            <label for="mostrarpreco" class="col-sm-2 col-form-label">Tipo de artigo </label>
              <div class="col-sm-8">
               <select class="form-control  select2bs4 @error('tipo') is-invalid @enderror" data-placeholder="seleciona  uma opção" style="width: 100%;" name="tipo" id="tipo">
                      ...
                      <option value="semanal"    {{ $artigo->tipo == "semanal" ? "selected": "" }}  >Semanal</option>
                      <option value="mensal"  {{ $artigo->tipo == "mensal" ? "selected": "" }} >Mensal</option>
                   </select>
                   @error('tipo')
                        <div class="invalid-feedback">
                            <h6>{{$message}}</h6>
