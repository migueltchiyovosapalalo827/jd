        ...
        <div class="card card-outline card-info">
            <div class="card-header">
                <div class="float-left">
                    <div class="btn-group">
                        <a href="{{ route('users.index') }}" class="btn btn-sm btn-block btn-secondary"><i class="fas fa-arrow-left"></i>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{route('users.update',$user->id) }}" method="post" class="form-horizontal">
                           ...
                           @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                <select class="select2" multiple="multiple" name="roles_list[]" data-placeholder="Select a State" style="width: 100%;">
