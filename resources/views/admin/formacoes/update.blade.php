...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form action="{{ route('formacoes.update', $formacao->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @method('PUT')
               @csrf
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" value="{{ $formacao->nome }}" placeholder="nome" autocomplete="off">
                        @error('nome')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" name="formador" class="form-control @error('formador') is-invalid @enderror" value="{{ $formacao->formador }}" placeholder="formador" autocomplete="off">
                        @error('formador')
                        <div class="invalid-feedback">
                            <h6>{{$message}}</h6>
                        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" name="custo" class="form-control @error('custo') is-invalid @enderror" value="{{ $formacao->custo }}" placeholder="custo" autocomplete="off">
                    @error('custo')
                    <div class="invalid-feedback">
                        <h6>{{$message}}</h6>
                    </div>
        ...
        <div class="form-group row">
            ...
            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                ...
                value="{{ $formacao->data}}" name="data" id="data">
